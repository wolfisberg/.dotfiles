...
awful.util.tagnames = { "web", "dev", "com", "utl", "msc", "mda", "fls" }
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey,           }, ".",
        ...
        {description = "focus next screen by index", group = "screen"}
    ),
    awful.key({ modkey,           }, ",",
        function ()
            awful.screen.focus_relative(-1)
        end,
        {description = "focus previous screen by index", group = "screen"}
    ),
    ...
    awful.key({ modkey }, "i",
              ...
              {description = "run prompt", group = "launcher"}),
    awful.key({ modkey }, "o",
                function () awful.spawn("rofi -show combi -combi-modi window,drun") end,
              {description = "run prompt", group = "launcher"}),
...
awful.rules.rules = {
    ...
    -- maybe switch to tag before launching as a work aorund?
    { rule = { class = "Spotify" },
      properties = { tag = "mda", switchtotag = true } },
    { rule = { class = "dolphin" },
      properties = { tag = "fls", switchtotag = true } },
    { rule = { class = "KeePassXC" },
      properties = { tag = "utl", switchtotag = true } },
    { rule = { class = "Thunderbird" },
      properties = { tag = "com", switchtotag = true } },
}
